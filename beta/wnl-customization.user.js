class CustomEventEmmiter{constructor(){this.listeners={}}addEventListener(t,n,e){if(this.listeners[t]||(this.listeners[t]=[]),e){const s=e=>{n.bind(this)(e),this.removeEventListener(t,s)};this.listeners[t].push(s)}else this.listeners[t].push(n)}removeEventListener(e,t){var n;if(this.listeners[e])return n=this.listeners[e].findIndex(e=>e==t),0<=n?this.listeners[e].splice(n,1)[0]:void 0}removeAllListeners(e){e?this.listeners[e]=[]:this.listeners={}}trigger(n,s={}){setTimeout(()=>{this.listeners[n]&&this.listeners[n].forEach(t=>{try{t.bind(this)(s)}catch(e){console.error(e,"triggering",n,"with data",s,"on",this,"with callback",t,`(${t.toString()})`)}})},0)}}var TabOpenerIndexes,Toggles,Keyboard,SettingType,Notes,__awaiter=this&&this.__awaiter||function(e,o,r,l){return new(r=r||Promise)(function(n,t){function s(e){try{a(l.next(e))}catch(e){t(e)}}function i(e){try{a(l.throw(e))}catch(e){t(e)}}function a(e){var t;e.done?n(e.value):((t=e.value)instanceof r?t:new r(function(e){e(t)})).then(s,i)}a((l=l.apply(e,o||[])).next())})};class ChapterListElement extends CustomEventEmmiter{constructor(e,t){super(),this.metadata=e,this.parent=t,e.children&&(this.children=e.children.map(e=>new ChapterListElement(e,t))),this.active=!1}get active(){return this._active}set active(e){this._active=e,this.trigger("activeChange",e),this.activeToggler&&(this.activeToggler.state=e)}getHTML(){return`<a class='custom-script-summary-link' href='${this.metadata.href}'>
    ...
    <path d="M0 12.995V13a3.07 3.07 0 0 0 0-.005z"/>`,cursor:inSVG`<path d="M14.082 2.182a.5.5 0 0 1 .103.557L8.528 15.467a.5.5 0 0 1-.917-.007L5.57 10.694.803 8.652a.5.5 0 0 1-.006-.916l12.728-5.657a.5.5 0 0 1 .556.103zM2.25 8.184l3.897 1.67a.5.5 0 0 1 .262.263l1.67 3.897L12.743 3.52 2.25 8.184z"/>`,arrowLeftCircle:inSVG`<path fill-rule="evenodd" d="M1 8a7 7 0 1 0 14 0A7 7 0 0 0 1 8zm15 0A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-4.5-.5a.5.5 0 0 1 0 1H5.707l2.147 2.146a.5.5 0 0 1-.708.708l-3-3a.5.5 0 0 1 0-.708l3-3a.5.5 0 1 1 .708.708L5.707 7.5H11.5z"/>`},zoomSliderHTML=`
...
`+this.options.desc))})}set upperLimit(e){this.input&&(this.input.max=e.toString())}set lowerLimit(e){this.input&&(this.input.min=e.toString())}getHTML(){return this.type===SettingType.Percent?`
    ...
    </div>`,this.prepareContainer(),this.addEventListener("loaded",e=>{e&&(this.lessonOpened=!1,this.goBackToggle.state=!1,this.container.append(e))}),this.setupOpenLinks()}setupOpenLinks(){this.lastURLUpdate=Date.now();const n=/lek.wiecejnizlek.pl\/app\/courses\/1\/lessons\/([0-9]+)\/([0-9]+)\/([0-9]+)/;this.addEventListener("iframeURLChange",e=>{this.goBackToggle.state=!0;var t=Date.now(),t=(console.log({now:t}),this.lastURLUpdate=t,n.exec(e));console.table(t),t&&(this.lessonOpened?this.trigger("urlChange",{url:e,lessonID:parseInt(t[1]),screenID:parseInt(t[2]),slide:parseInt(t[3])}):this.lessonOpened=!0)})}prepareContainer(){this.container=document.createElement("div"),this.container.innerHTML=CourseSidebar.CONTAINER_HTML,this.container.classList.add("custom-main-nav-container"),this.collapseToggler=new ClassToggler("active",this.container),this.container.querySelector("a.custom-expand").addEventListener("click",()=>this.collapseToggler.toggle());const e=this.container.querySelector("a.custom-go-back");this.goBackToggle=new ClassToggler("hidden",e),this.goBackToggle.invert=!0,e.addEventListener("click",()=>this.load())}attach(e){e.prepend(this.container)}show(){this.container&&(this.container.style.display="")}hide(){this.container&&(this.container.style.display="none")}destroy(){this.container.remove(),super.destroy()}}CourseSidebar.URLChangeTime=1e3,CourseSidebar.CONTAINER_HTML=`
...
.custom-main-nav-container .loading .navigation-group__toggle {
    opacity: 0.8;
}

.custom-main-nav-container .loading .navigation-group__toggle:nth-child(2) {
    opacity: 0.6;
}

.custom-main-nav-container .loading .navigation-group__toggle:nth-child(3) {
    opacity: 0.3;
}

.custom-main-nav-container .loading .navigation-group__toggle:nth-child(4) {
    opacity: 0.1;
}
